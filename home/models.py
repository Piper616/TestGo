...
class EvaluacionCaso(models.Model):
    ...
    video_respuesta = models.ForeignKey('Video', models.DO_NOTHING, db_column='video_respuesta')
...
class Video(models.Model):
    id_video = models.FloatField(primary_key=True)
    video = models.BinaryField(blank=True, null=True)
    id_evaluado = models.ForeignKey(Evaluado, models.DO_NOTHING, db_column='id_evaluado')
